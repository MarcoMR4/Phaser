...
function disparo(){
    ...
    //    // Añadir una variable para controlar la amplitud del movimiento senoidal
    //    var amplitud = 30; 

    //    juego.time.events.loop(Phaser.Timer.SECOND * 0.1, function () {
    //        // Calcular la posición en el eje Y usando una función senoidal
    //        var tiempoActual = juego.time.now;
    //        if(bala.position.y >= 10)
    //        {    
    //         bala.position.y = h - amplitud * Math.sin((bala.position.x / 100) + (100));
    //        }
